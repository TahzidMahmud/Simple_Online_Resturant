    ...
    <div class="section center" style="padding: 40px;">
        ...
        <form action="../backends/admin/cat-add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col s6" style="">
                            <div class="input-field">
                            <input id="short_desc" name="short_desc" placeholder="Must Be in Few Line" type="text" class="validate" style="color: white; width: 70%">
            ...
            <div class="row">
                ...
                <div class="input-field ">
                <label class="btn" for="image" style="color:#ffff;display:flex;justify-content:center;">Add Image</label>
