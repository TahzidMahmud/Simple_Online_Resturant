    ...
    <div class="section center" style="padding: 40px;">
        ...
        <form action="../backends/admin/food-add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="input-field">
                <input id="desc" name="desc" type="text" placeholder="in one line please" class="validate" style="color: white; width: 70%">
                <label for="desc" style="color: white;"><b>Short Description :</b></label>
                </div>
            ...
            <div class="row">
                ...
                <div class=" input-field">
                    <div class="btn col m6 offset-6" style="margin-top:25px;">
                        <label  for="image" style="color:#ffff;display:flex;justify-content:center;">Add Image</label>
                        <input id="image" style=" opacity: 0!important;z-index:-4;" name="image" type="file">
                    </div>
                    <div class="input-field col m5  offset-m1">
                        <input id="price" name="price" type="number" class="validate" style="color: white; width: 100%">
