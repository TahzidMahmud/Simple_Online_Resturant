...
$sql = "INSERT INTO orders(order_id,user_id,food_id,user_name, timestamp,quantity,bill) VALUES(?,?,?,?,?,?,?)";

$query  = $pdoconn->prepare($sql);

if ($query->execute([$order_id, $user_id, $food_id, $user_name, $timest,$quantity,$bill])) {

	$_SESSION['msg'] = 'Order Placed! Your Order ID is  : '.$order_id ." ".'Please Note This ID For Further Reference ';
