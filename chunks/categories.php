			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator responsive-img" style="max-height:20vh;min-height:20vh;width:100%;"  src="images/<?php echo $arr_all[$i+$j-2]['image']; ?>">
				    </div>
				    <div class="card-content">
				      ...
				      <div class="card-content" style="height:25vh;overflow-y:scroll;">
