<section class="loginmodal">
	<div id="modal1" class="modal">
	    <div class="modal-content center">
		  ...
		  <a href="javascript:void(0)" class="modal-close waves-effect waves-light btn" id="login_btn" style="background: #f33242  !important;">Login</a>
		  <a href="admin/" ><span style="margin-left:60px!important;">Are You Admin..?Then Click.</span></a>
